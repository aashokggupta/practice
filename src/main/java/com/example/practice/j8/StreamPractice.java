...
//		System.out.println(sum);
		 ...
		 */
		List<Addresss> addressList1 = new ArrayList<>();
		addressList1.add(new Addresss("Delhi"));
		addressList1.add(new Addresss("Gurgaon"));
		
		List<Addresss> addressList2 = new ArrayList<>();
		addressList1.add(new Addresss("Delhi"));
		addressList1.add(new Addresss("Noida"));
		
		List<Employees> employeeList = new ArrayList<>();
		employeeList.add(new Employees(123, addressList1));
		employeeList.add(new Employees(200, addressList2));
...
class Employees {
	...
	public Employees(int id, List<Addresss> addressList) {
		this.id = id;
